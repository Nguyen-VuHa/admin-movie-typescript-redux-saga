...
function ModalEditPoster() {
    ...
    const { modalEditImg, thumbnailsBase64 } = useAppSelector(state => state.studioVideoState);
    ...
    useEffect(() => {
        if(croppedAreaPixels) {
            let timOut = setTimeout(() => {
                getCroppedImg(thumbnailsBase64, croppedAreaPixels)
                .then((res: any) => {
                    setImageBase64(res);
                ...
                <div className={cx('layout-preview')}>
                    ...
                    <div className='d-flex w-100'>
                        ...
                        <Button
                            onClick={() => {
                                if(imageBase64) {
                                    dispatch(setImageThumbnail(imageBase64));
